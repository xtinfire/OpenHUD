// overlays/hud/src/HudView.jsx — TAM HALİ
...
export function HudView({ state, suggestion, config }) {
  ...
  return (
    <>
      ...
      {/* Minimap artık HUD'un kendi içinde, sol üst köşede sabit */}
      <div style={{ position: 'fixed', top: 76, left: 12, width: 220, height: 220 }}>
        <Minimap state={state} config={config} embedded />
      </div>
      ...
      {isVertical ? (
        ...
        <div style={{
          position: 'fixed', top: 70, left: 0, width: '100%',
